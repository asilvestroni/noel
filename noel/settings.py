...
SECRET_KEY = os.environ.get('DJANGO_SECRET') or 'default-secret'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DJANGO_DEBUG') != 'False' and True

ALLOWED_HOSTS = ["localhost", "127.0.0.1", "130.136.143.51", "sfp.smartdata.cs.unibo.it"]
